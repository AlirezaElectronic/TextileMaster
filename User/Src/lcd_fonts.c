/****
	...
	* @brief font data, users can add or delete by themselves
   *****************************************************************************************************************************************************************************************************************************************
   *  @description
	*
	* Experimental platform: anti-customer STM32H7 core board
	* Eshop: https://kavirelectronic.ir/eshop
	* TELEGRAM ID:   @kavirsupport
	*
>>>>> File description:
	*
	* 1.ASCII character set: !"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\]^_`abcdefghijklmnopqrstuvwxyz{|}~
	* 2.ASCII fonts, there are a total of 5 sizes of fonts: 3216, 2412, 2010, 1608, 1206, all in Song font
	* 3. Chinese character templates also come in five sizes: 3232, 2424, 2020, 1616, 1212
	* 4. The Chinese character library is a small character library, that is, the corresponding Chinese characters are used and then the model is taken.
	* 5. Each font model in the Chinese character library must have a corresponding Chinese character as an index.
	*
>>>>> Description of mold taking method:
	*
	* 1. Impression taking software PCtolCD2018
	* 2. Negative code, reverse, progressive, C51 format.
	*
	****************************************************** ****************************************************** ****************************************************** ****************************************************** **************************************FAN*****
***/
...
//Chinese character font data, font is 1212
// When adding a new font, it must not exceed the size of the first dimension of the array. Users can adjust it according to their needs.
// Chinese punctuation marks and English punctuation marks are different! If the Chinese punctuation marks are not modulated, the punctuation marks must be entered in English and the ASCII font model must be used when displaying.
//Each font must be followed by a corresponding Chinese character as an index
//
const uint8_t  Chinese_1212[50][24]=	
{ 
// Chinese(0) Text(1) Character(2) Style(3): (4) Anti(5) Guest(6) Science(7) Technology(8)
...
//Chinese character font data, font is 1616
// When adding a new font, it must not exceed the size of the first dimension of the array. Users can adjust it according to their needs.
// Chinese punctuation marks and English punctuation marks are different! If the Chinese punctuation marks are not modulated, the punctuation marks must be entered in English and the ASCII font model must be used when displaying.
//Each font must be followed by a corresponding Chinese character as an index
//
...
//Chinese character font data, font is 2020
// When adding a new font, it must not exceed the size of the first dimension of the array. Users can adjust it according to their needs.
// Chinese punctuation marks and English punctuation marks are different! If the Chinese punctuation marks are not modulated, the punctuation marks must be entered in English and the ASCII font model must be used when displaying.
//Each font must be followed by a corresponding Chinese character as an index
//
...
//Chinese character font data, font is 2424
// When adding a new font, it must not exceed the size of the first dimension of the array. Users can adjust it according to their needs.
// Chinese punctuation marks and English punctuation marks are different! If the Chinese punctuation marks are not modulated, the punctuation marks must be entered in English and the ASCII font model must be used when displaying.
//Each font must be followed by a corresponding Chinese character as an index
//
...
{ 
// Brush the screen to test the core board model screen resolution: text
// Display, Chinese and character sets can be displayed
// Users can add and delete fonts according to needs
// Subtract the extra digits and fill in the spaces with positive and negative integers
// In front of the small three primary color level background layer
...
//Chinese character font data, font is 3232
// When adding a new font, it must not exceed the size of the first dimension of the array. Users can adjust it according to their needs.
// Chinese punctuation marks and English punctuation marks are different! If the Chinese punctuation marks are not modulated, the punctuation marks must be entered in English and the ASCII font model must be used when displaying.
//Each font must be followed by a corresponding Chinese character as an index
//
...
{ 
//Text display
// Medium font: Antike Technology
//Variable refresh test color
// Draw a rectangular filled image and draw a vertical double layer
...
/************************************************ ****************************************************** ****************************************************** ****************************************************** ******************************************FAN*****/
/*	
	* 1. The following is ASCII font data
	* 2.ASCII character set: !"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\]^_`abcdefghijklmnopqrstuvwxyz{|}~
	* 3.ASCII font, Song font, there are a total of 5 sizes of fonts: 3216, 2412, 2010, 1608, 1206
*/
/************************************************ ****************************************************** ****************************************************** ****************************************************** ******************************************FAN*****/
...
/*------------------------------------ Define related font parameters------- -----------------------------------------------*/

pFONT Font32 = {
	ASCII_3216_Table, // Font module array address
	16, // Font width of a single character
	32, // Font length of a single character
	64, //The number of font data for a single character
	0 // This parameter is only used by Chinese character fonts and represents the row size of the two-dimensional array.
};

pFONT Font24 = {			
	ASCII_2412_Table, // Font module array address
	12, // Font width of a single character
	24, // Font length of a single character
	48, //The number of font data for a single character
	0 // This parameter is only used by Chinese character fonts and represents the row size of the two-dimensional array.
};

pFONT Font20 = {
	ASCII_2010_Table, // Font module array address
	10, // Font width of a single character
	20, // Font length of a single character
	40, //The number of font data for a single character
	0 // This parameter is only used by Chinese character fonts and represents the row size of the two-dimensional array.
};

pFONT Font16 = {
	ASCII_1608_Table, // Font module array address
	8, // Font width of a single character
	16, // Font length of a single character
	16, //The number of font data for a single character
	0 // This parameter is only used by Chinese character fonts and represents the row size of the two-dimensional array.
};

pFONT Font12 = {
	ASCII_1206_Table, // Font module array address
	6, // Font width of a single character
	12, // Font length of a single character
	12, //The number of font data for a single character
	0 // This parameter is only used by Chinese character fonts and represents the row size of the two-dimensional array.
};
