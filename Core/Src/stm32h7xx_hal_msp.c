  ...
  */
  ...
  /* USER CODE BEGIN FMC_MspInit 1 */
	...
	//  HAL_GPIO_Init(GPIOD, &GPIO_InitStruct);
		...
		__HAL_RCC_SYSCFG_CLK_ENABLE();				//Ê¹ÄÜSYSCFGÊ±ÖÓ
	...
	//	HAL_SYSCFG_AnalogSwitchConfig(SYSCFG_SWITCH_PC3,SYSCFG_SWITCH_PC3_CLOSE);
	    ...
	    HAL_GPIO_Init(GPIOD,&GPIO_Initure); //³õÊ¼»¯PD0,1,8,9,10,14,15
	    ...
	    HAL_GPIO_Init(GPIOE,&GPIO_Initure); //³õÊ¼»¯PE0,1,7,8,9,10,11,12,13,14,15
	    ...
	    HAL_GPIO_Init(GPIOF,&GPIO_Initure); //³õÊ¼»¯PF0,1,2,3,4,5,11,12,13,14,15

	    GPIO_Initure.Pin=GPIO_PIN_0|GPIO_PIN_1|GPIO_PIN_2|GPIO_PIN_4|GPIO_PIN_5|GPIO_PIN_8|GPIO_PIN_15;
	    HAL_GPIO_Init(GPIOG,&GPIO_Initure);	//³õÊ¼»¯PG0,1,2,4,5,8,15
